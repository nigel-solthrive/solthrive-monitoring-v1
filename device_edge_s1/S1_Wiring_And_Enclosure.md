...
* White = I+
* Black = I−
* (Some CTs have non-polarized pairs — refer to CT spec sheet)

* *(Note: “I+” and “I−” are the meter’s CT input terminals. The “I” stands for **current**, not the letter “L”. Wiring a CT’s positive lead to I+ and negative lead to I− ensures the meter reads current direction correctly. If reversed, import/export values flip.)*
...
* **DIN-rail carrier** (180–250 mm recommended)
* **UL94-V0 plastic or metal enclosure**
* **Cable glands** for CT + RS485 entry
* **Ventilation slots** (Pi generates heat)
...
5. Terminate CT wiring inside the service panel
6. Route CT leads into the enclosure
...
# 📎 10. Future Additions (S2/S3 Roadmap)
